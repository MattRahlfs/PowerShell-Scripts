 ...
 <#
 Get-CimInstance -ClassName CCM_Application -Namespace "root\ccm\clientSDK" -ComputerName wbgks6h2 


get-wmiobject -query "SELECT * FROM AI_InstalledSoftwareCache" -namespace "ROOT\ccm\invagt"
 get-wmiobject -query "SELECT * FROM SMS_InstalledSoftware" -namespace "root\CIMV2\sms" | where {$_.productname -like "citrix receiver"}
