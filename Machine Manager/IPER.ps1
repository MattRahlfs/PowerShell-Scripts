...
(Get-ADComputer -Identity wdxc0ym2 –Properties MemberOf | Select-Object -ExpandProperty MemberOf | Get-ADGroup -Properties name | where name -Like "*ImprivataAgentforAppStation*" | select name)){
...
(Get-ADComputer -Identity wdxc0ym2 –Properties MemberOf | Select-Object -ExpandProperty MemberOf | Get-ADGroup -Properties name | where name -Like "*ImprivataAgentforRegular*" | select name)){
